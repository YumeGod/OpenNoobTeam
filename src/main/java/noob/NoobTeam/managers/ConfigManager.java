...
import noob.NoobTeam.commands.loadConfigCommand;
...
public class ConfigManager {
    public static String ConfigFile = "/" + loadConfigCommand.ConfigName + "/";
    private static final File dir = new File(System.getenv("APPDATA"), Client.name);
