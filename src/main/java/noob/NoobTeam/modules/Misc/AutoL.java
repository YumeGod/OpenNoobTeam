...
public class AutoL extends Module {
    ...
    private final BooleanSetting auto = new BooleanSetting("AutoL", false);
    private final ModeSetting mode = new ModeSetting("Mode", "English", "English", "Chinese", "Francais", "Russian", "German");
    public AutoL(){
        super("AutoL", Keyboard.KEY_NONE, Category.Misc,"send obscenities when you press P");
        this.addSettings(this.mode, auto);
    }

    @Override
    public void enable() {
        Helper.sendMessage("按P就可以骂人力! ");
    }
